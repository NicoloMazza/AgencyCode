...
public class ModificaDatiAccountBND extends JFrame {
    ...
    public ModificaDatiAccountBND(UtenteENT datiCampi) {
        ...
        titolo_schermata = new JLabel("MODIFICA DATI ACCOUNT");
        ...
        cognome.setBounds(350, 265, 225, 25);
        pannello.add(cognome);

        campoCognome = new JTextField(datiCampi.getCognome());
        campoCognome.setBounds(500, 265, 290, 25);
        ...
        ruolo.setBounds(350, 315, 225, 25);
        pannello.add(ruolo);

        campoRuolo = new JTextField(Integer.toString(datiCampi.getServizio()));
        campoRuolo.setBounds(500, 315, 290, 25);
        ...
        conferma.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                    String em = campoEmail.getText();
                    String pas = campoPassword.getText();
                    String ib = campoIban.getText();
                    if ( !(em.equals("")) && !(pas.equals("")) && !(ib.equals("")) ) {
                        if (MetodiUtili.isValidEmailAddress(em) && ModificaDatiAccountCTRL.modificaDati(datiCampi, em, pas, ib) != null) {
                                ModificaDatiAccountCTRL.creaMessaggioASchermo("Dati modificati con successo.",
                                                2);
                        } else {
                                ModificaDatiAccountCTRL.creaMessaggioASchermo(
                                                "Errore durante la modifica dei dati.", 1);
                        }
                        dispose();
                        new GestioneUtenteBND(datiCampi);
                    }
                    else {
                        ModificaDatiAccountCTRL.creaMessaggioASchermo("I campi non possono essere vuoti!", 1);
                    }
            }
        });
