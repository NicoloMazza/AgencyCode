...
public class GestioneProgettiBND extends JFrame {
	...
	public GestioneProgettiBND(UtenteENT ent) {
		...
		conferma.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String data[][] = GestioneProgettiCTRL.mostraProgetti(text, text2, text3);

				String col[] = { "Codice:", "Descrizione:", "Stato:" };
		...
		titolo_schermata = new JLabel("GESTIONE PROGETTI\r\n");
		...
		filtro2 = new JLabel("Descrizione: ");
