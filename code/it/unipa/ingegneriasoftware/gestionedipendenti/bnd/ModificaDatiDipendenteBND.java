...
public class ModificaDatiDipendenteBND extends JFrame {
    ...
    public ModificaDatiDipendenteBND(UtenteENT ent, UtenteENT datiCampi) {
        ...
        titolo_schermata = new JLabel("MODIFICA DATI DIPENDENTE");
...
/*
        ...
        password.setBounds(370, 515, 225, 25);
...
*/
        ...
        conferma.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                datiCampi.setNome(campoNome.getText());
                datiCampi.setCognome(campoCognome.getText());
                datiCampi.setServizio(Integer.parseInt(campoRuolo.getText()));
                datiCampi.setIban(campoIban.getText());
                datiCampi.setEmail(campoEmail.getText());
                datiCampi.setOreDaRecuperare(Integer.parseInt(campoOre.getText()));
                if (MetodiUtili.isValidEmailAddress(datiCampi.getEmail()) && ModificaDatiDipendenteCTRL.modificaDipendente(datiCampi)) {
                    AggiungiDipendenteCTRL.creaMessaggioASchermo("Dati modificati con successo.", 2);
                } else {
                    AggiungiDipendenteCTRL.creaMessaggioASchermo("Errore durante la modifica dei dati.", 1);
                }
                dispose();
